...
import { generateNodeJSRTMSClient } from '../lib/codeGenerator';
      ...
      <section className="bg-gradient-to-br from-blue-600 to-cyan-500 rounded-2xl p-6 text-white shadow-lg">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-bold mb-2">Quick Integration</h2>
            <p className="text-blue-100 text-sm mb-4">
              View sample code and integration endpoints for your RTMS client.
            </p>
            <button
